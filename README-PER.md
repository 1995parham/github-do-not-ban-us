...
<div dir="rtl">
گیت‌هاب سابقا پلتفرمی رایگان و قابل استفاده برای همگان بود، اما الآن تصمیم به محدودکردن اکانت‌های ایرانی در سهم‌داشتن و عضوی از اکوسیستم متن‌باز بودن گرفته است.
...
**آپدیت:** اکنون می‌توان مخزن‌های خصوصی را به مخزن عمومی تبدیل کرد. هرچند کماکان این امکان برای گیست‌های خصوصی (که ممکن است شامل اطلاعات مهمی باشند) وجود ندارد.

**آپدیت:** صفحه‌های گیت‌هاب کار می‌کنند.

- محدودکردن کاربران بر اساس ملیتشان را از سیاست‌های تحدید خود حذف کند.
- تصمیم خود را به صورت عمومی اعلام کرده و به خاطر به وجود آوردن این وضعیت از کاربران خود عذرخواهی به عمل آورد. (مانند کاری که اسلک در شرایط مشابه کرد:‌ https://slackhq.com/an-apology-and-an-update)
...
## <div dir="rtl">چگونه می‌توانید از ما حمایت کنید؟ </div>
 ...
 <div dir="rtl">.شما می‌توانید این پیام را هرجای ممکن پخش کنید از نرم‌افزار آزاد، به مثابه آزادی بیان حفاظت کنید
...
- یک فولدر با نام کاربری خود در فولدر ["together"](together) این مخزن اضافه کنید.
...
پیشنهاد می‌کنیم لینک‌های زیر را مطالعه کنید.
<div dir="ltr">
